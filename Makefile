...
.PHONY: tools check safety stable-liveness queue-recovery-liveness failure-liveness explore explore-sequence
...
check: safety stable-liveness queue-recovery-liveness failure-liveness
...
queue-recovery-liveness:
	$(TLC) -config K8sPodNodeGpuQueueRecovery.cfg K8sPodNodeGpu
